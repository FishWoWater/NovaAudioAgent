...
import { capabilitiesFromSettings, resolveModelApiKey, resolveProactivity, type Settings } from '../config/config.js'
...
import type { ExecutorManifest } from '../core/ports.js'
import type {AgentDescriptor} from '../executors/agent-controller.js'
import { stripLikePython } from '../text/python-text.js'
import { buildSimulator, simManifestRegistry } from '../core/sims.js'
import { compileToolSchema, type CompiledTools } from '../core/tool-schema.js'
import type { ModelCall } from '../core/runtime.js'
