...
const rows: readonly Row[] = [
  ...
  ['NOVA_AUDIO_AGENT_CAMERA_MODULE_ENABLED', 'camera', false, true, 'never', 'true', 'Enable independent Vision monitoring.', '启用独立视觉监控。'],
  ...
  ['NOVA_AUDIO_AGENT_CASCADE_LLM_PROVIDER', 'core', false, true, 'never', 'deepseek', 'Cascaded LLM provider.', '级联 LLM 提供方。'],
  ...
  ['NOVA_AUDIO_AGENT_SEARCH_MCP_TOOL', 'search', false, true, 'never', 'web_search', 'Web search MCP tool override (generic default web_search; Bailian preset search_pro).', '网页搜索 MCP 工具覆盖（通用默认 web_search；百炼预设 search_pro）。'],
  ...
  ['NOVA_AUDIO_AGENT_MEMORY_CONNECTION', 'core', false, true, 'never', 'local', 'Memory connection: disabled, local, or remote.', '记忆连接：disabled、local 或 remote。'],
  ['NOVA_AUDIO_AGENT_MEMORY_PROVIDER', 'core', false, true, 'never', null, 'Local engine: mem0 (default) or voicemem. Remote engines are service-owned.', '本地引擎：mem0（默认）或 voicemem。远程引擎由服务端选择。'],
  ...
  ['NOVA_AUDIO_AGENT_VOLCENGINE_VAD_SILENCE_END_MS', 'volcengine', false, true, 'never', '300', 'VAD silence endpoint duration.', 'VAD 静音断句时长。'],
  ['NOVA_AUDIO_AGENT_VOLCENGINE_VAD_SPEECH_PAD_MS', 'volcengine', false, true, 'never', '30', 'VAD speech padding.', 'VAD 语音补边。'],
  ['NOVA_AUDIO_AGENT_VOLCENGINE_VAD_MAX_UTTERANCE_MS', 'volcengine', false, true, 'never', '60000', 'VAD maximum utterance duration.', 'VAD 最长话语时长。'],
