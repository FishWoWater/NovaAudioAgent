...
const TIMING_FIELDS = Object.freeze({
  vadPreRollMs: 'VOLCENGINE_VAD_PRE_ROLL_MS',
  vadMinSpeechMs: 'VOLCENGINE_VAD_MIN_SPEECH_MS',
  vadSilenceEndMs: 'VOLCENGINE_VAD_SILENCE_END_MS',
  vadSpeechPadMs: 'VOLCENGINE_VAD_SPEECH_PAD_MS',
  vadMaxUtteranceMs: 'VOLCENGINE_VAD_MAX_UTTERANCE_MS',
} as const)
