...
import {requireSelectedCascadedRealtimeConfig} from '../../dist/src/config/cascaded-realtime-config.js'
import {buildCascadedRealtimeAssembly, cascadedProviderRegistries as registry} from '../../dist/src/composition/cascaded-realtime-assembly.js'
