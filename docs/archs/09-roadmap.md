...
for every executor integration. Home Assistant and the earlier MyContext integration idea remain later candidates, not release requirements; any memory-backend evaluation must preserve the personal/workspace separation.
See the [planning overview](../specs/v0.3.0/00-overview.md),
